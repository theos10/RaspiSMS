<?php
	...
	class Sendeds extends \Model
    {
        ...
        {
            $sendeds = $this->getFromTableWhere('sendeds', ['id' => $id]);
        ...
        {
            $sendeds = $this->getFromTableWhere('sendeds', [], '', false, $limit, $offset);
        ...
        {
            $sendeds = $this->getFromTableWhere('sendeds', [], 'at', true, $nb_entry);
            return $sendeds;
        }
        
        /**
         * Cette fonction retourne une liste des sendeds sous forme d'un tableau
		...
		{
            $sendeds = $this->getFromTableWhere('sendeds', ['target' => $target]);
            return $sendeds;
        }
        ...
        {
            $result = $this->insertIntoTable('sendeds', $sendeds);
        ...
        {
            return $this->updateTableWhere('sendeds', $sended, ['id' => $id]);
        }
        ...
        {
            return $this->countTable('sendeds');
        }
