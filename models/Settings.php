<?php
	...
	class Settings extends \Model
    {
        ...
        {
            $settings = $this->getFromTableWhere('settings', ['id' => $id]);
        ...
        {
            $settings = $this->getFromTableWhere('settings', ['name' => $namer]);
            return isset($settings[0]) ? $settings[0] : false;
        }
        ...
        {
            $settings = $this->getFromTableWhere('settings', [], '', false, $limit, $offset);
        ...
        {
            return $this->updateTableWhere('settings', ['value' => $value], ['name' => $name]);
        }
