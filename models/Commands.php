<?php
	...
	class Commands extends \Model
    {
        ...
        {
            $commands = $this->getFromTableWhere('commands', ['id' => $id]);
        ...
        {
            $commands = $this->getFromTableWhere('commands', [], '', false, $limit, $offset);
        ...
        {
            $result = $this->insertIntoTable('commands', $command);
        ...
        {
            return $this->updateTableWhere('commands', $command, ['id' => $id]);
        }
        ...
        {
            return $this->countTable('commands');
        }
    }
