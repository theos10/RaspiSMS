			...
			<ul class="nav navbar-right top-nav">
				<li class="dropdown">
					...
					<ul class="dropdown-menu">
						...
						<li class="divider"></li>
						<li>
							<a href="<?php echo $this->generateUrl('Account', 'logout'); ?>"><i class="fa fa-fw fa-power-off"></i> Déconnexion</a>
						</li>
					</ul>
				</li>
			</ul>
			...
			<div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
					...
					<li <?php echo $page == 'scheduleds' ? 'class="active"' : ''; ?>>
						<a href="<?php echo $this->generateUrl('Scheduled', 'list'); ?>"><i class="fa fa-fw fa-envelope"></i> SMS</a>
					</li>
					<li <?php echo $page == 'discussions' ? 'class="active"' : ''; ?>>
						<a href="<?php echo $this->generateUrl('Discussion', 'list'); ?>"><i class="fa fa-fw fa-comments"></i> Discussions</a>
					</li>
					...
					<li>
						...
						<ul id="repertoire" class="collapse <?php echo in_array($page, array('contacts', 'groupes')) ? 'in' : ''; ?>">
							<li <?php echo $page == 'contacts' ? 'class="active"' : ''; ?>>
								<a href="<?php echo $this->generateUrl('Contact', 'list'); ?>"><i class="fa fa-fw fa-user"></i> Contacts</a>
							</li>
							<li <?php echo $page == 'groupes' ? 'class="active"' : ''; ?>>
								<a href="<?php echo $this->generateUrl('Groupe', 'list'); ?>"><i class="fa fa-fw fa-group"></i> Groupes</a>
							</li>
						</ul>
					</li>
					<li>
						...
						<ul id="logs" class="collapse <?php echo in_array($page, array('sendeds', 'receiveds', 'events', 'smsstop')) ? 'in' : ''; ?>">
							<li <?php echo $page == 'sendeds' ? 'class="active"' : ''; ?>>
								<a href="<?php echo $this->generateUrl('Sended', 'list'); ?>"><i class="fa fa-fw fa-send"></i> SMS envoyés</a>
							</li>
							<li <?php echo $page == 'receiveds' ? 'class="active"' : ''; ?>>
								<a href="<?php echo $this->generateUrl('Received', 'list'); ?>"><i class="fa fa-fw fa-download"></i> SMS reçus</a>
							</li>
							...
							<li <?php echo $page == 'events' ? 'class="active"' : ''; ?>>
								<a href="<?php echo $this->generateUrl('Event', 'list'); ?>"><i class="fa fa-fw fa-clock-o"></i> Évènements</a>
							</li>
						</ul>
					</li>
					<li <?php echo $page == 'users' ? 'class="active"' : ''; ?>>
						<a href="<?php echo $this->generateUrl('User', 'list'); ?>"><i class="fa fa-fw fa-user"></i> Utilisateurs</a>
					</li>
					<?php if ($_SESSION['user']['admin']) { ?>
						<li <?php echo $page == 'settings' ? 'class="active"' : ''; ?>>
							<a href="<?php echo $this->generateUrl('Setting', 'show'); ?>"><i class="fa fa-fw fa-cogs"></i> Réglages</a>
						</li>
					<?php } ?>
				</ul>
			</div>
