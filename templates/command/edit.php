			...
			<div class="row">
				<div class="col-lg-12">
					...
					<ol class="breadcrumb">
						...
						<li>
							<i class="fa fa-terminal"></i> <a href="<?php echo $this->generateUrl('Command', 'list'); ?>">Commandes</a>
						</li>
						<li class="active">
				...
				<div class="col-lg-12">
					<div class="panel panel-default">
						...
						<div class="panel-body">
							<form action="<?php echo $this->generateUrl('Command', 'update', ['csrf' => $_SESSION['csrf']]);?>" method="POST">
								<?php
...
?>
								...
								?>
								<a class="btn btn-danger" href="<?php echo $this->generateUrl('Command', 'list'); ?>">Annuler</a>
