			...
			<div class="row">
				<div class="col-lg-12">
					...
					<ol class="breadcrumb">
						...
						<li>
							<i class="fa fa-calendar"></i> <a href="<?php echo $this->generateUrl('Scheduled', 'list'); ?>">Scheduleds</a>
						</li>
						<li class="active">
				...
				<div class="col-lg-12">
					<div class="panel panel-default">
						...
						<div class="panel-body">
							<form action="<?php echo $this->generateUrl('Scheduled', 'create', ['csrf' => $_SESSION['csrf']]);?>" method="POST">
								...
								<?php } ?>
								<a class="btn btn-danger" href="<?php echo $this->generateUrl('Scheduled', 'list'); ?>">Annuler</a>
	...
	jQuery(document).ready(function()
	{
		jQuery('.add-contacts').each(function()
		{
			jQuery(this).magicSuggest({
				data: '<?php echo $this->generateUrl('Contact', 'json_list'); ?>',
				valueField: 'id',
				displayField: 'name',
			});
		});
		...
		{
			jQuery(this).magicSuggest({
				data: '<?php echo $this->generateUrl('Groupe', 'json_list'); ?>',
				valueField: 'id',
				displayField: 'name',
			});
		});
