			...
			<div class="row">
				<div class="col-lg-12">
					...
					<ol class="breadcrumb">
						...
						<li>
							<i class="fa fa-user"></i> <a href="<?php echo $this->generateUrl('Contact', 'list'); ?>">Contacts</a>
						</li>
						<li class="active">
				...
				<div class="col-lg-12">
					<div class="panel panel-default">
						...
						<div class="panel-body">
							<form action="<?php echo $this->generateUrl('Contact', 'update', ['csrf' => $_SESSION['csrf']]);?>" method="POST">
							<?php
							...
							?>
								<a class="btn btn-danger" href="<?php echo $this->generateUrl('Contact', 'list'); ?>">Annuler</a>
