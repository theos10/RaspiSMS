			...
			<div class="row">
				<div class="col-lg-12">
					...
					<ol class="breadcrumb">
						...
						<li>
							<i class="fa fa-comments-o"></i> <a href="<?php echo $this->generateUrl('Discussion', 'list'); ?>">Discussions</a>
						</li>
						<li class="active">
							<?php $this->s($number); ?>
						</li>
			...
			<div class="row">
				...
				<div class="col-lg-12 message-input-container">
					<div class="discussion-message message-input">
						<form class="send-message-discussion" action="<?php $this->s($this->generateUrl('Discussion', 'send', ['csrf' => $_SESSION['csrf']])); ?>" method="POST">
