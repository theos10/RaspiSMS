			...
			<div class="row">
				<div class="col-lg-12">
					...
					<ol class="breadcrumb">
						...
						<li>
							<i class="fa fa-group"></i> <a href="<?php echo $this->generateUrl('Groupe', 'list'); ?>">Groupes</a>
						</li>
						<li class="active">
				...
				<div class="col-lg-12">
					<div class="panel panel-default">
						...
						<div class="panel-body">
							<form action="<?php echo $this->generateUrl('Groupe', 'create', ['csrf' => $_SESSION['csrf']]);?>" method="POST">
								...
								<a class="btn btn-danger" href="<?php echo $this->generateUrl('Groupe', 'list'); ?>">Annuler</a>
