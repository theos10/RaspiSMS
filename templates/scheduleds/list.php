                            ...
                            <form method="GET">
                                ...
                                <div>
                                    ...
                                    <div class="text-right col-xs-6 no-padding">
                                        ...
                                        <button class="btn btn-default" type="submit" formaction="<?php echo $this->generateUrl('Scheduleds', 'edit'); ?>"><span class="fa fa-edit"></span> Modifier</button>
                                        <button class="btn btn-default" type="submit" formaction="<?php echo $this->generateUrl('Scheduleds', 'delete', ['csrf' => $_SESSION['csrf']]); ?>"><span class="fa fa-trash-o"></span> Supprimer</button>
                                    </div>
                                </div>
                            </form>
                        </div>
